...
def apply_tsne(data):
    ...
    sns.scatterplot(data_embedded[:, 0], data_embedded[:, 1], legend='full', palette=palette)
    ...
    if using_h5:
        ...
        for skeleton_index, skeleton_part in enumerate(skeleton_parts):
            ...
            for frame in np.arange(n_frames):
                ...
                skeleton_parts_pos_array[skeleton_index, 1, frame] = skeleton_h5_data_array[frame, (skeleton_index * 3) + 1]
                skeleton_parts_pos_array[skeleton_index, 2, frame] = skeleton_h5_data_array[frame, (skeleton_index * 3) + 2]
                        ...
                        for frame_index in indices:
                            if frame_index == 0:
                                ...
                                if frame_index+1 in indices:
                                    ...
                                    parts_pos_array[part_index, 0, frame_index] = parts_pos_array[part_index, 0, frame_index+1]
                                    parts_pos_array[part_index, 1, frame_index] = parts_pos_array[part_index, 1, frame_index+1]
                            else:
        ...
        apply_tsne(data=data_to_cluster)
        pos_h5_file.close()
